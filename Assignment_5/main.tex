...
\end{align}
Let us represent $ \pr{X=x,Y=y}$ as the pmf of $x, y$, depending on $\lambda$: $p_{XY}\brak{x, y}$.
...
\begin{align}
    ...
    &\geq-\frac{1}{E\brak{\frac{\partial^2\brak{ \ln{\comb{y}{x}}-y\ln{2^y}+y\ln{\lambda}-\ln{y!}-\lambda}}{\partial\lambda^2}}}\\
